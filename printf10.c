...
/************************* WRITE NUMBER *************************/
/**
 * write_number - display a stringto std output
...
/************************* WRITE HANDLE *************************/
/**
 * handle_write_char - display a string to std out
 * @t: char types.
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags.
 * @width: get width.
 ...
 * Return: Number of chars printed.
 */
int handle_write_char(char t, char buffer[],
	int flags, int width, int precision, int size)
 ...
 * @ind: number starts on the buffer
 * @buffer: the Buffer
 * @flags: used Flags
...
/**
 * write_pointer - returns a memory address
 * @buffer: Arrays of chars
 * @ind: Index at which the number starts in the buffer
 * @length: Length of integer
 * @width: Width determined
...
/**
 * write_unsgnd - displays an unsigned number to std output
 * @is_negative: indicates num is negative
 * @ind: begining of the integer in the buffer
 * @buffer: Array of characters
 * @flags: Flags specifiers
 * @width: Width determinant
 * @precision: Precision specifier
